...
<template>
  <BaseModal
    :open="uiStore.moveModalVisible"
    :title="t('batch.addToCategory')"
    size="small"
    @close="uiStore.hideMoveModal"
  >
    <form id="move-tab-form" @submit.prevent="handleSave">
    ...
    <template #actions>
      ...
      <button type="submit" form="move-tab-form" class="btn primary">
        {{ t('batch.add') }}
      </button>
    </template>
  </BaseModal>
