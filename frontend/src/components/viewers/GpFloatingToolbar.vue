      ...
      <div v-if="activePanel === 'search'" class="toolbar-panel" @click.stop>
        ...
        <div class="panel-content">
          ...
          <div class="quick-jumps">
            ...
            <button @click="emit('jump-to-bar', Math.floor(measureCount / 4))">Â¼</button>
            <button @click="emit('jump-to-bar', Math.floor(measureCount / 2))">Â½</button>
            <button @click="emit('jump-to-bar', Math.floor(measureCount * 3 / 4))">Â¾</button>
